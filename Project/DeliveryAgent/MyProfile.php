...
include("Head.php");
session_start();
$deliveryagentname=$_SESSION['dname'];
$deliveryagentID=$_SESSION['did'];
$SelDeliveryAgent="select * from tbl_deliveryagent where deliveryagent_ID=".$deliveryagentID;
$resDeliveryAgent=$con->query($SelDeliveryAgent);
$data=$resDeliveryAgent->fetch_assoc();	
?>
...
<form id="form1" name="form1" method="post" action="">
  <table width="200" border="1">
    <tr>
      <td colspan="2" align="center"><img src="../Asset/Files/product/<?php echo $data['deliveryagent_photo']; ?>" width="200" height="200" />
    </tr>
    <tr>
      <td>Name</td>
