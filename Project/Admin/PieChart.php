        ...
        <form ID="form1" name="form1" method="post" action="">
            ...
            <center>
                <div class="col-lg-6 grID-margin grID-margin-lg-0 stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Sales Per user</h4>
            ...
            if (isset($_POST["btnsave"])) {
                // Fetch users and their sales data
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $sel = "SELECT * FROM tbl_booking o 
                                                    ...
                                                    INNER JOIN tbl_product p ON c.product_ID = p.product_ID 
                                                    INNER JOIN tbl_user s ON s.user_ID = p.user_ID 
                                                    WHERE cart_status IN (1,3,4) 
                                                    AND o.booking_date BETWEEN '" . $_POST["txt_f"] . "' AND '" . $_POST["txt_t"] . "'";
                                            $row = $con->query($sel);
                                            $i = 0;
                                            while ($data = $row->fetch_assoc()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($data["cart_quantity"]); ?></td>
                                                    <td><?php echo htmlspecialchars($data["user_name"]); ?></td>
                                                    <td><?php echo htmlspecialchars($data["user_contact"]); ?><br><?php echo htmlspecialchars($data["user_email"]); ?></td>
