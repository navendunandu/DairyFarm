...
<body>
<center>
    <h1 class="text-success"><u>Customer Max Sales Report</u></h1><br>
    <form name="frm_prod" method="POST" action="">
        ...
        if (isset($_POST['btn_submit'])) {
            ...
            $selqry = "SELECT 
                            u.user_name, u.user_photo, u.user_email, u.user_contact, u.user_address, u.user_gender, u.user_dob, 
                            COUNT(c.cart_ID) AS total_items
                        FROM 
                            tbl_user u
                        JOIN 
                            tbl_booking b ON u.user_ID = b.user_ID
                        JOIN 
                                ...
                                <div class="card-body bg-warning">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-center">
                                            <img src="../Assets/Files/Userdocs/<?php echo $data['user_photo']; ?>" class="img-fluid rounded-circle mb-3" alt="Profile Picture" width="150">
                                        </div>
