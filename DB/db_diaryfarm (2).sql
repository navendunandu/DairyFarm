...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2024 at 01:00 PM
...
CREATE TABLE `tbl_newuser` (
  ...
  `newuser_name` varchar(50) NOT NULL,
  `newuser_gender` varchar(50) NOT NULL,
  `newuser_contact` varchar(50) NOT NULL,
  `newuser_email` varchar(50) NOT NULL,
  `newuser_password` varchar(50) NOT NULL,
  `newuser_photo` varchar(100) NOT NULL,
  `newuser_proof` varchar(100) NOT NULL,
  `place_id` int(11) NOT NULL,
  `newuser_address` int(56) NOT NULL,
  `newuser_dob` varchar(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `tbl_newuser`
  MODIFY `newuser_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `tbl_stock`
  MODIFY `stock_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=160;
