...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2024 at 04:36 PM
...
--
CREATE DATABASE IF NOT EXISTS `db_diaryfarm` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_diaryfarm`;
...
INSERT INTO `tbl_booking` (`booking_ID`, `booking_status`, `booking_date`, `user_ID`, `booking_amount`, `admin_ID`, `category_name`, `category_ID`, `subcategory_name`, `subcategory_ID`, `deliveryagent_ID`, `dis_amount`) VALUES
(3, 5, '2024-08-27', 7, '60', 0, '', 0, '', 0, 5, 0),
(4, 5, '2024-08-27', 6, '60', 0, '', 0, '', 0, 5, 0),
(5, 5, '2024-08-29', 7, '50', 0, '', 0, '', 0, 5, 0),
(8, 5, '2024-08-30', 6, '950', 0, '', 0, '', 0, 3, 0),
(9, 5, '2024-09-09', 6, '50', 0, '', 0, '', 0, 5, 0),
(10, 5, '2024-09-10', 6, '100', 0, '', 0, '', 0, 5, 0),
(11, 2, '2024-09-18', 6, '50', 0, '', 0, '', 0, 0, 0),
(12, 4, '2024-10-26', 6, '770', 0, '', 0, '', 0, 5, 0),
(13, 2, '2024-10-26', 6, '200', 0, '', 0, '', 0, 0, 0),
(14, 5, '2024-10-26', 6, '1500', 0, '', 0, '', 0, 5, 0),
(15, 0, '', 6, '', 0, '', 0, '', 0, 0, 0);
...
CREATE TABLE `tbl_cart` (
  ...
  `cart_subcategory` varchar(100) NOT NULL,
...
INSERT INTO `tbl_cart` (`cart_ID`, `cart_quantity`, `cart_status`, `product_ID`, `booking_ID`, `cart_total`, `category_name`, `stock_ID`, `cart_subcategory`, `dis_ID`) VALUES
(1, 4, 4, 119, 1, 0, '', 0, '', 0),
(2, 2, 1, 115, 2, 0, '', 0, '', 0),
(3, 3, 1, 122, 3, 0, '', 0, '', 0),
(4, 3, 1, 120, 4, 0, '', 0, '', 0),
...
(13, 2, 1, 117, 10, 0, '', 0, '', 0),
(14, 1, 1, 112, 11, 0, '', 0, '', 0),
(16, 10, 1, 114, 12, 0, '', 0, '', 0),
(17, 10, 1, 122, 13, 0, '', 0, '', 0),
(18, 1, 1, 119, 14, 0, '', 0, '', 0);
...
INSERT INTO `tbl_stock` (`stock_ID`, `stock_date`, `stock_quantity`, `product_ID`, `stock_mfd`, `stock_exp`, `subcategory_ID`, `category_ID`, `category_name`, `subcategory_name`) VALUES
(141, '2024-08-24', '4', 0, '', '', 0, 0, '', ''),
(142, '2024-08-24', '4', 0, '', '', 0, 0, '', ''),
(150, '2024-08-30', '2', 0, '', '', 0, 0, '', ''),
(151, '2024-08-30', '2', 0, '', '', 0, 0, '', ''),
(152, '2024-08-30', '4', 0, '', '', 0, 0, '', ''),
(160, '2024-10-26', '400', 0, '', '', 0, 0, '', ''),
(161, '2024-10-26', '4000', 0, '', '', 0, 0, '', '');
...
--
ALTER TABLE `tbl_stock`
  MODIFY `stock_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;
...
('root', '[{\"db\":\"db_diaryfarm\",\"table\":\"tbl_deliveryagent\"},{\"db\":\"db_diaryfarm\",\"table\":\"tbl_discount\"},{\"db\":\"db_diaryfarm\",\"table\":\"tbl_district\"},{\"db\":\"db_diaryfarm\",\"table\":\"tbl_place\"},{\"db\":\"db_diaryfarm\",\"table\":\"tbl_product\"},{\"db\":\"db_diaryfarm\",\"table\":\"tbl_rating\"},{\"db\":\"db_diaryfarm\",\"table\":\"tbl_stock\"},{\"db\":\"db_diaryfarm\",\"table\":\"tbl_subcategory\"},{\"db\":\"db_diaryfarm\",\"table\":\"tbl_wishlist\"},{\"db\":\"db_diaryfarm\",\"table\":\"tbl_newuser\"}]');
...
('root', 'db_diaryfarm', 'tbl_wishlist', '{\"CREATE_TIME\":\"2024-10-31 19:32:35\",\"col_order\":[0,1,2,3,4],\"col_visib\":[1,1,1,1,1],\"sorted_col\":\"`tbl_wishlist`.`wishlist_ID` ASC\"}', '2024-10-31 14:14:20');
...
('root', '2024-10-31 15:36:28', '{\"Console\\/Mode\":\"collapse\"}');
